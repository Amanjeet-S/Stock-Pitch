...
Equity research write-ups I've done on my own time. Each one is a full pitch: the idea, the numbers behind it, what has to go right for it to work, and what would tell me I'm wrong.

Two reasons this repo exists. It forces me to finish a thesis instead of leaving half of it in a notebook, and it leaves a record.

**Amanjeet Singh** · [LinkedIn](https://www.linkedin.com/in/singh-amanjeet/) · [email](mailto:amanjeet.s@hotmail.com)
...
> **Update, 21 Aug 2026.** The catalyst named in the pitch has passed. Q2 came in ahead of consensus on 13 August, with H1 EBT up 39.4%, North America still growing and full-year guidance reaffirmed, so the margin pillar of the thesis held. The write-up itself is unchanged from 27 July. Editing a call after you know how it went defeats the point of publishing it.

---

## What's in each pitch

Same structure every time, so they're quick to compare:

1. **Thesis in one paragraph.** If I can't say it in five sentences, I don't understand it yet.
2. **Why now.** The dated catalyst that makes it a trade rather than an observation.
3. **Business.** How the company actually makes money, who owns it, how it's financed.
4. **Variant perception.** Where the market has it wrong, and why the gap hasn't closed already.
5. **Financial summary.** Five years of the numbers that matter, with the distortions called out rather than smoothed over.
6. **Valuation.** Bear, base and bull, with the multiple and the assumption behind it stated plainly.
7. **Catalysts.** What closes the gap, with dates where they're scheduled.
8. **Risks and mitigants.** Including the ones I can't hedge.
9. **What would prove me wrong.** Specific and falsifiable. No vague hand-waving about macro.
10. **Positioning.** Size, structure, horizon. Pair trade where the thesis is relative rather than absolute.
11. **Sources**, plus a short list of what I'd verify before committing real capital.
...
**Notional book: USD 1,000,000, fixed at inception.** Weights are percentages of that figure and it does not move with performance. Riyal positions are converted at the 3.64 peg.
...
I'm Amanjeet Singh. This is where I keep my equity work.
...
If you hire for research, or you've read one of these and think the call is wrong, I'd rather hear it than not. [Email](mailto:amanjeet.s@hotmail.com) is the quickest way to reach me.
